...
//        Environment env = new Environment("https://test-payment.momo.vn/v2/gateway/api", devInfo, "development");
        ...
        PartnerInfo devInfo = new PartnerInfo("MOMOLRJZ20181206", "mTCKt9W3eU1m39TW", "KqBEecvaJf1nULnhPF5htpG3AMtDIOlD");
//        MoMoEndpoint endpoint = new MoMoEndpoint("https://test-payment.momo.vn/v2/gateway/api/create");
...
//        CreateOrderMoMo
// Debug: Print out the environment and partner info
        System.out.println("Environment: " + env);
//        System.out.println("Partner Info: " + env.getPartnerInfo());

// Create and execute PayATM request
        PayATMRequest payATMRequest = atmProcess.createPayWithATMRequest(requestId, orderId, bankCode, amount, orderInfo, returnURL, notifyURL, "", env.getPartnerInfo());
...
//        PayATMResponse payATMResponse1 = PayATM.process(env, requestId, orderId, bankCode, amount, orderInfo, returnURL, notifyURL, extraData);
        ...
        System.out.println("PayATMResponse: " + payATMResponse);
